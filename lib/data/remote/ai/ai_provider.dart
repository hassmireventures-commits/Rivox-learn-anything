...
enum AiProviderType {
  builtin(
    BuiltInAiConfig.displayName,
    BuiltInAiConfig.defaultModel,
    BuiltInAiConfig.baseUrl,
  ),
  openai(
    'OpenAI',
    'gpt-4o-mini',
  ...
  bool get supportsJsonObjectMode => switch (this) {
        ...
        AiProviderType.custom =>
          true,
        // NIM models often reject response_format; retry path still works if enabled.
        AiProviderType.builtin => false,
        AiProviderType.gemini || AiProviderType.claude => false,
      };

  bool get isBuiltin => this == AiProviderType.builtin;
