...
class AiProviderFactory {
  static AiProvider create({
    ...
    if (key.isEmpty) {
      throw const InvalidApiKeyException('API key is required.');
    }
    if (model.isEmpty) {
      throw const UnknownException('Model is required.');
    }
    ...
    switch (type) {
      ...
      case AiProviderType.custom:
        ...
        if (resolvedBase.isEmpty) {
          throw const UnknownException('Base URL is required for custom providers.');
        }
