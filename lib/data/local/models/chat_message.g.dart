...
void _chatMessageSerialize(
  ...
  writer.writeString(offsets[0], object.contextRef);
...
ChatMessage _chatMessageDeserialize(
  ...
  object.contextRef = reader.readStringOrNull(offsets[0]);
...
extension ChatMessageQueryFilter
  ...
  contextRefIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'contextRef'),
      );
    });
  }
  ...
  contextRefIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'contextRef'),
      );
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
  contextRefEqualTo(String? value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
          property: r'contextRef',
          value: value,
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
  contextRefStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
  contextRefEndsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
  contextRefContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
  contextRefMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  contextRefIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'contextRef', value: ''),
      );
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
  contextRefIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'contextRef', value: ''),
      );
    });
  }
...
extension ChatMessageQuerySortBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByContextRef() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'contextRef', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByContextRefDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'contextRef', Sort.desc);
    });
  }
...
extension ChatMessageQuerySortThenBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByContextRef() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'contextRef', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByContextRefDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'contextRef', Sort.desc);
    });
  }
...
extension ChatMessageQueryWhereDistinct
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByContextRef({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'contextRef', caseSensitive: caseSensitive);
    });
  }
...
extension ChatMessageQueryProperty
  ...
  QueryBuilder<ChatMessage, String?, QQueryOperations> contextRefProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'contextRef');
    });
  }
